...
import fr.eql.ai111.projetcda.coindelice.ecommerce.serivce.impl.AdminServiceImpl;
...
public class LoginController {
    ...
    public String addNewAdmin(@Valid @ModelAttribute("adminDto")AdminDto adminDto,
        ...
        try {
            ...
            if(admin != null){
                model.addAttribute("adminDto", adminDto);
                System.out.println("l'admin n'est pas nulle");
                model.addAttribute("emailError", "Ton email a été bien enregistré!");
                return "register";
            }
            if(adminDto.getPassword().equals(adminDto.getRepeatPassword())){
                ...
                model.addAttribute("adminDto", adminDto);
                model.addAttribute("passwordError", "Votre mot de passe est  erroné !");
                System.out.println("les mots de passe ne sont pas identiques ");
                return "register";
            }
        }catch (Exception e){
            e.printStackTrace();
            model.addAttribute("errors", "Problème de serveur!");
        }
        return "register";
